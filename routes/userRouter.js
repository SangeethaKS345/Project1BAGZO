...
const { userAuth, checkBlockStatus, redirectIfUserAuthenticated } = require("../middlewares/auth");
...
router.get("/signup", redirectIfUserAuthenticated, userController.loadSignup);
router.post("/signup", userController.signup);
router.post("/verify-otp", userController.verifyOtp);
router.post("/resend-otp", userController.resendOtp);
router.get("/signin", redirectIfUserAuthenticated, userController.loadLogin);
...
router.post("/resetPassword", userController.forgotPasswordSendLink);
